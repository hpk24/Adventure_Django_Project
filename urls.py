...
urlpatterns = [
                ...
                path('updateUserPacakageAdventure/<int:id>/', views.updateUserPacakageAdventure, name='updateUserPacakageAdventure'),
                path('userpackages/', views.userpackages, name='userpackages'),
                path('deleteUserPacakageAdventure/<int:id>/', views.deleteUserPacakageAdventure, name='deleteUserPacakageAdventure'),
